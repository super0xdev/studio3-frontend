...
export type ShapeSizeOption =
  | [number | Percentage, string]
  | [number | Percentage, string, any];

export type ShapeLineEndOption =
  | [LineEndStyle, string]
  | [LineEndStyle, string, any];
...
export interface PinturaEditorHeadlessOptions
  extends PinturaEditorImageOptions {
  imageReader?: any;
  imageWriter?: any;
  imageScrambler?: any;
  shapePreprocessor?: any;
...
export interface PinturaEditorModal
  extends PinturaEditor,
...
export type PinturaStoreField =
  | [string, string]
  | [string, Blob | File, string];
...
export const shapeGetLevel: (
  shapeState: {
    flipX: undefined | boolean;
    flipY: undefined | boolean;
    rotation: number;
  },
...
export const createMarkupEditorLineHeightOptions: (
  sizes: number[]
) => ShapeSizeOption[];
export const createMarkupEditorLineHeightScaleOptions: (
  sizes: SizeCategories
) => ShapeSizeOption[];
